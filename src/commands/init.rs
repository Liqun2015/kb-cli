...
This schema is generated by `kb-cli v0.4.3`. It is intentionally simple and should evolve with the project.
"#
}
...
```text
outputs/reports/wiki_lint_YYYY-MM-DD.md
```
"#
}
