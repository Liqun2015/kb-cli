...
///
/// v0.7.9 prefers the lowercase `knowledgebase/` workspace directory,
...
This schema is generated by `kb-cli v0.7.9`. It is intentionally simple and should evolve with the project.
"#
}
